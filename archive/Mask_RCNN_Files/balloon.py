...
try:
    ...
    from Mask_RCNN_Files.config import Config
    import Mask_RCNN_Files.model as modellib
    import Mask_RCNN_Files.utils as utils

# Path to trained weights file
COCO_WEIGHTS_PATH = os.path.join(ROOT_DIR, "mask_rcnn_coco.h5")

LAST_WEIGHTS_PATH = os.path.join(ROOT_DIR, "mask_rcnn_label_0010.h5")
